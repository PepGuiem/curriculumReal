...
caballero.src = document.querySelector("image").src;
const caballeroRight = new Image();
caballeroRight.src = "./img/caballero-mirada-derecha.png";
const caballeroLeft = new Image();
caballeroLeft.src = "./img/caballero-mirada-izquierda.png";
const cofre = new Image();
cofre.src = "./img/cofre.png";
const paredes = new Image();
paredes.src = "./img/paredes-mazmorra.jpg";
const suelo = new Image();
suelo.src = "./img/suelo-mazmorra.jpg";
var level = 1;
var level1 = [
    [
        "X",
